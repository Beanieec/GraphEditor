...
// GraphEditorT.cpp: определяет поведение классов для приложения.
//
...
// Создание CGraphEditorTApp

CGraphEditorTApp::CGraphEditorTApp() noexcept
{
	...
	SetAppID(_T("GraphEditorT.AppID.NoVersion"));

	// TODO: добавьте код создания,
	// Размещает весь важный код инициализации в InitInstance
}

// Единственный объект CGraphEditorTApp

CGraphEditorTApp theApp;


// Инициализация CGraphEditorTApp

BOOL CGraphEditorTApp::InitInstance()
{
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(CGraphEditorTDoc),
		RUNTIME_CLASS(CMainFrame),       // основное окно рамки SDI
		RUNTIME_CLASS(CGraphEditorTView));
	if (!pDocTemplate)
		return FALSE;
...
int CGraphEditorTApp::ExitInstance()
{
...
void CGraphEditorTApp::OnAppAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}
